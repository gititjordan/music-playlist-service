...
public final class AlbumTrackTestHelper {
    ...
    public static AlbumTrack generateAlbumTrack(int sequenceNumber) {
        ...
        albumTrack.setAlbum("album" + sequenceNumber);
        albumTrack.setTitle("title" + sequenceNumber);
        return albumTrack;
    }
    ...
    public static void assertAlbumTrackEqualsSongModel(AlbumTrack albumTrack, SongModel songModel, String message) {
        ...
        assertEquals(albumTrack.getAlbum(), songModel.getAlbum(), message);
        assertEquals(albumTrack.getTitle(), songModel.getTitle(), message);
    }
}
